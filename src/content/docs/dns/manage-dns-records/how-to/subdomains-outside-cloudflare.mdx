...
## Deletegate a subdomain (incoming)

To delegate a subdomain from your existing DNS servers to Cloudflare, please refer to [subdomain setups](dns/zone-setups/subdomain-setup).
