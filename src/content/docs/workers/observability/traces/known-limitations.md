...
Lack of trace context propagation currently creates an additional trace if your Worker is making a call to another Worker via service bindings or to a Durable Object. 
